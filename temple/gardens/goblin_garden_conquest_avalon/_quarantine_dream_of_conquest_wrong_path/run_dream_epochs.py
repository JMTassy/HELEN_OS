...
temple/gardens/goblin_garden_conquest_avalon/dream_of_conquest/
...
EPOCHS = [
    ...
    ("E012", "WULMOJI_CONQUEST_GRAMMAR", "validator", {
        ...
        "temple_sim_view_forbidden": [
            ...
            "CANON_IS_TRUE_PROHIBITED",
            "AUTHORITY_IS_TRUE_PROHIBITED",
            "SOVEREIGN_IS_TRUE_PROHIBITED",
        ],
        "emojos_patch_summary": {
            ...
            "patch_7": "EMOJOS is one-way: StructuredState→RenderString only; RenderString→StructuredState forbidden",
    ...
    ("E018", "AUTORESEARCH_EVALUATOR", "validator", {
        ...
        "criteria": {
            ...
            "skip_rate_target": "Action skip rate < 20 percent by T40",
    ...
    ("E025", "GOBLIN_GARDEN_CONQUEST_COMPLETE", "receipt", {
        ...
        "emojos_patch_notes": [
            "PASS/GATE_CLEARED semantic split — authority vocab excluded from TEMPLE artifacts",
