...
class ReasonCode(str, Enum):
    ...
    ERR_MANIFEST_HASH_MISSING = "ERR_MANIFEST_HASH_MISSING"
    ERR_MANIFEST_REGISTRY_MISS = "ERR_MANIFEST_REGISTRY_MISS"
    ERR_MANIFEST_HASH_MISMATCH = "ERR_MANIFEST_HASH_MISMATCH"
